...
Apache®, Apache Hadoop, Hadoop®, Apache Flink™, Flink™, the yellow elephant logo and the squirrel logo are either registered trademarks or trademarks of the [Apache Software Foundation](http://apache.org) in the United States and/or other countries.